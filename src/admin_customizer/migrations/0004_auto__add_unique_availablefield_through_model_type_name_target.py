...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'AvailableField', fields ['through', 'model', 'type', 'name', 'target']
        db.create_unique('admin_customizer_availablefield', ['through_id', 'model_id', 'type', 'name', 'target_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'AvailableField', fields ['through', 'model', 'type', 'name', 'target']
        db.delete_unique('admin_customizer_availablefield', ['through_id', 'model_id', 'type', 'name', 'target_id'])
