...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'RegisteredModel.active'
        db.add_column('admin_customizer_registeredmodel', 'active', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'RegisteredModel.active'
        db.delete_column('admin_customizer_registeredmodel', 'active')
